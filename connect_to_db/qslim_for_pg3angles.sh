...
INPUT_FILE_PATH_D='/home/sato/Desktop/dp/las_data_samples/clip_txt/ctsmall2495.txt'
WORK_DIR_D='/home/sato/Desktop/dp/connect_to_db/'
SRID_D='21781'
#QSLIM OPTIMIZATION PARAMETERS
FACE_COUNT_D=10000
EDGE_CONTRACTION_POLICY_D=3
#!!!!!!!!!!!!! IMPORTANT KEEP THIS PARAMETER VALUE 0, OTHERWISE QSLIM CREATES TIN WITH DUPLICATE GEOMETRY 
WEIGHT_D=0
